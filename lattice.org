...
#############
base_dir <- "~/data/flow/"
## work_dir <- paste0(base_dir, "2020.06.28_TDH3pr_mCh_TFT_rpn4_flow/fcs")
work_dir <- paste0(base_dir, "2020.06.26_TDH3pr_mCh_TFT_0662_flow/fcs")
...
no_reporter  <- paste0(".*untagged.*", reporter_name, ".*fcs") 
by_strain    <- paste0("BY.*", reporter_name, ".*fcs") 
rm_strain    <- paste0("RM.*", reporter_name, ".*fcs") 
rpn4_strain  <- paste0("rpn4.*", reporter_name, ".*fcs") 
ubr1_strain  <- paste0("ubr1.*", reporter_name, ".*fcs") 
doa10_strain <- paste0("doa10.*", reporter_name, ".*fcs") 
pop_1_strain <- paste0("SFA.*pop_001.*", reporter_name, ".*fcs") 
pop_5_strain <- paste0("SFA.*pop_005.*", reporter_name, ".*fcs") 
pop_6_strain <- paste0("SFA.*pop_006.*", reporter_name, ".*fcs") 
